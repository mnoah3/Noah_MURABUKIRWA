...
public class RemoteInternship extends Internship {
    ...
    public void trackProgress() {
        System.out.println("Tracking progress for Remote internship.");
    }

    @Override
    public void generateReport() {
        System.out.println("Generating remote report for internship:");
        ...
        System.out.println("Remote report access provided.");
    }
    ...
    public void validateInternship() {
        if (endDate.isBefore(startDate)) {
            ...
            System.out.println("Remote Internship validated successfully.");
        }
    }
}