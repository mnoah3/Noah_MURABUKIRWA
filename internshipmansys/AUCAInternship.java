...
public class AUCAInternship extends Internship {
    ...
    public void assignSupervisor() {
        if (supervisor.getQualification().equals("Masters") || supervisor.getQualification().equals("PhD")) {
    ...
    public void trackProgress() {
        System.out.println("Tracking progress for AUCA internship.");
    }

    @Override
    public void generateReport() {
        System.out.println("Generating report for AUCA internship:");
